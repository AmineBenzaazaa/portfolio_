    ...
    <div className="flex flex-row items-center justify-center px-20 mt-[150px] z-[20] ">
      <div className="flex flex-col  justify-center  text-center">
        <div className="justify-center flex ">
          <Image src="/Me.png" height={300} width={300} alt="Amine Benzaazaa" />
        </div>
        ...
        <p className="text-md text-gray-200 my-5 max-w-[600px]">
          Passionate Software Developer with a focus on React Native & React JS development,
          dedicated to crafting elegant and user-friendly mobile & web applications.
        </p>
        <div className="text-md flex justify-center">
          <button
            onClick={() => window.open("mailto:Medzaza910@gmail.com")}
